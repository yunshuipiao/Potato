...
public class BubbleLayout extends FrameLayout {
    ...
    private void initValues() {
        mLook = Look.BOTTOM;
        mLookWidth = Utils.dpToPx(getContext(), 10);
        mLookLength = Utils.dpToPx(getContext(), 10);
        mShadowRadius = Utils.dpToPx(getContext(), 0);
        mShadowX = Utils.dpToPx(getContext(), 0);
        mShadowY = Utils.dpToPx(getContext(), 0);
        mBubbleRadius = Utils.dpToPx(getContext(), 3);
        mBubblePadding = Utils.dpToPx(getContext(), 0);
        mShadowColor = Color.RED;
        mBubbleColor = Color.BLACK;
    }
